...
export default function Page(): JSX.Element {
  ...
  return (
    <main className="flex items-center justify-center">
      ...
      <div className="flex p-2 items-center justify-center w-1/2 h-screen flex-col gap-24">
        <div className=" flex max-h-20 max-w-96 items-center justify-center flex-col gap-3">
          <h1 className="text-3xl font-medium text-center">Welcome to Finalcad</h1>
